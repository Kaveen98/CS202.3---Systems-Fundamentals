                            ...
                            <div class="panel-body">
                                ...
                                <div id="doctorlist" class="switchgroup">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <%! int deptId; String deptName; String deptDesc; %>
                                            <% Connection c=(Connection)application.getAttribute("connection");
                                                ...
                                                ResultSet rs=ps.executeQuery(); while(rs.next()) { deptId=rs.getInt(1);
                                                deptName=rs.getString(2); deptDesc=rs.getString(3); %>
                                                <tr>
                                                    <td>
                                                        <%=deptId%>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-primary"
                                                            data-toggle="modal" data-target="#myModal<%=deptId%>"><span
                                                                class="glyphicon glyphicon-wrench"
                                                                aria-hidden="true"></span></button>
                                                        <a href="delete_dept_validation.jsp?deptId=<%=deptId%>"
                                ...
                                <% while(rs.next()) { deptId=rs.getInt(1); deptName=rs.getString(2);
                                                    ...
                                                    <div class="panel panel-default">
                                                        <div class="panel-body">
                                                            <form class="form-horizontal"
                                                                action="edit_dept_validation.jsp">
